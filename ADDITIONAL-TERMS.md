...
Software Foundation. This program is distributed in the hope that it will be useful,
but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or
FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more
details. You should have received a copy of the GNU General Public License along
with this program; it is in [LICENSE](LICENSE) and also at
<https://www.gnu.org/licenses/gpl-3.0.html>.

Every file that carries `SPDX-License-Identifier: GPL-3.0-only` points here, because
section 7 of that license allows the terms below and requires that the source files
say where to find them.

English is the binding version of this document. The Spanish text at the end is a
courtesy translation.

## The terms

These are additional terms in the sense of section 7 of the GNU GPL v3. Nothing here
takes away a permission the GPL grants you; they only add the requirements that
section 7 allows a copyright holder to add. If any of them is held unenforceable, the
rest stay in force and the work remains under the GPL.
...
README or a store page, keep the same attribution there.

### 2. Mark modified versions as different (GPL v3, section 7c)

If you distribute a modified version, mark it in reasonable ways as different from
the original:
...
Contributions are accepted under GPL-3.0-only with these same additional terms, and
there is no CLA: you keep the copyright over what you write. See
...
PARTICULAR. El texto de la licencia está en [LICENSE](LICENSE).
...
2. **Marcar las versiones modificadas (7c).** Si distribuyes una versión modificada,
   indícalo de forma razonable: dilo en «Acerca de», di quién la modificó, no la
